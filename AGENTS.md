...
**Backend:** Python 3.12+, FastAPI, SQLAlchemy 2.0+, Pydantic 2.8+, Psycopg3, Alembic, uvicorn. Optional: LiveKit Agents SDK 1.5.x for voice, Transformers/Torch for local inference.
